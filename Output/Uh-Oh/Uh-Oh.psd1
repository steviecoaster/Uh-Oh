#
# Module manifest for module 'Uh-Oh'
#
...
Description = 'PowerShell API wrapper for the Staytus incident status web application'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'status','staytus','monitoring','chatops'

        # A URL to the license for this module.
        LicenseUri = 'https://raw.githubusercontent.com/steviecoaster/Uh-Oh/main/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/steviecoaster/Uh-Oh'
